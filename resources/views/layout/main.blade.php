...
<head>
    ...
    <link href="<?php echo asset('assets/css/sb-admin-2.min.css" rel="stylesheet') ?>">
    <link href="<?php echo asset('assets/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet') ?>">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Rokibul Hassan 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
